...
class MuonBall(OrthogonalizedOptimizer):
    ...
    Args:
        ...
        radius_scaler: Multiplier applied to the target radius.
    ...
    def _compute_component_update(
        ...
        """
        R = compute_target_radius(
            shape=W.shape, radius_mode=self.radius_mode, radius_scaler=self.radius_scaler
        )
